...
var CellWrapper = /*#__PURE__*/function (_Component) {
  ...
  _createClass(CellWrapper, [{
    ...
    value: function render() {
      ...
      var className = "cp_tree-table_cell " + ((_row$data = row.data) !== null && _row$data !== void 0 && _row$data.isTotalLine && indexKey === 0 ? 'topPartial' : (_row$data2 = row.data) !== null && _row$data2 !== void 0 && _row$data2.isTotalLine ? 'topFull' : '');
      return /*#__PURE__*/React.createElement("div", {
        className: className,
...
var VirtualListRow = /*#__PURE__*/function (_Component) {
  ...
  _createClass(VirtualListRow, [{
    key: "render",
    value: function render() {
      var _row$data, _row$data2, _row$data3;
      ...
      if (((_row$data = row.data) === null || _row$data === void 0 ? void 0 : _row$data.type) == 'transactionEntity') {
        console.log(row);
      }
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        style: _objectSpread2(_objectSpread2({}, STYLE_ROW$1), {}, {
          ...
          background: row.data.type == 'transactionEntity' ? (row.data.indexTxn + 1) % 2 !== 0 ? '#e6e6eb' : 'white' : 'none',
          borderTop: row.data.type == 'transactionEntity' && row.data.indexTxn === 0 ? 'solid 2px black' : 'none',
          borderLeft: row.data.type == 'transactionEntity' ? 'solid 2px black' : 'none',
          borderRight: row.data.type == 'transactionEntity' ? 'solid 2px black' : 'none',
          borderBottom: row.data.type == 'transactionEntity' && ((_row$data2 = row.data) === null || _row$data2 === void 0 ? void 0 : _row$data2.indexTxn) === ((_row$data3 = row.data) === null || _row$data3 === void 0 ? void 0 : _row$data3.totalPayees) - 1 ? 'solid 2px black' : 'none' // ...(row.data.type == 'transactionEntity' &&
        ...
        return /*#__PURE__*/React.createElement(CellWrapper, {
          ...
          grow: column.grow,
          basis: column.basis,
          columnTotal: columns.length // background={
